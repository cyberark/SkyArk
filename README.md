...
**Note:** In addition to SkyArk, you can try CyberArk Cloud Entitlements Manager for free, it offers discovery and remediation of all excessive permissions – not only those for admin and shadow admin – across AWS, Azure, and GCP. You can test these capabilities at cyberark.com/cem {: .note}
